...
<ProofSequence
  title="One project, several durable systems"
  description="The Brightside Studio project keeps related context and execution surfaces together."
  items={[
    { title: 'The whole project boundary', src: '/docs/proof/project-overview.png', alt: 'The complete Brightside project Overview', caption: 'Working agreement, sessions, and repeatable work share one durable home.' },
    { title: 'Independent work threads', src: '/docs/proof/sessions-panel.webp', alt: 'The project Sessions panel with two distinct outcomes', caption: 'Each objective keeps its own continuing identity inside the project.' },
    { title: 'Repeatable project work', src: '/docs/proof/routines-panel.webp', alt: 'The project Routines panel with scheduled, triggered, and manual workflows', caption: 'The same project boundary governs work that runs later or repeatedly.' },
  ]}
/>
